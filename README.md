...
// any .astro page
---
<p>Views: <viztas-counter slug="blog">…</viztas-counter></p>
...
<style>
  viztas-counter { font-weight: 600; } /* style it like any element */
</style>
```
...
```ts
defineViztasCounter(options?): void   // registers <viztas-counter slug endpoint cooldown>
```
