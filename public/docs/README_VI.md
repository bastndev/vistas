...
---
<p>Lượt xem: <vistas-counter slug="blog">…</vistas-counter></p>
...
<style>
  vistas-counter { font-weight: 600; } /* styled như bất kỳ element nào */
</style>
```
...
```ts
defineVistasCounter(options?): void   // đăng ký <vistas-counter slug endpoint cooldown>
```
