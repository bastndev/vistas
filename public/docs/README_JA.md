...
// 任意の .astro ページ
---
<p>ビュー数：<vistaz-counter slug="blog">…</vistaz-counter></p>
...
<style>
  vistaz-counter { font-weight: 600; } /* 任意の要素のようにスタイル付け */
</style>
```
...
### エレメント — `vistaz/element`

```ts
defineViztasCounter(options?): void   // <vistaz-counter slug endpoint cooldown> を登録
```
