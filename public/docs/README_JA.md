...
// 任意の .astro ページ
---
<p>ビュー数：<vistas-counter slug="blog">…</vistas-counter></p>
...
<style>
  vistas-counter { font-weight: 600; } /* 任意の要素のようにスタイル付け */
</style>
```
...
```ts
defineVistasCounter(options?): void   // <vistas-counter slug endpoint cooldown> を登録
```
