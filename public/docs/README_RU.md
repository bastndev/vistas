...
---
<p>Просмотры: <viztas-counter slug="blog">…</viztas-counter></p>
...
<style>
  viztas-counter { font-weight: 600; } /* стилизуйте как любой элемент */
</style>
```
...
```ts
defineViztasCounter(options?): void   // регистрирует <viztas-counter slug endpoint cooldown>
```
