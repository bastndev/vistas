...
---
<p>Vues : <vistas-counter slug="blog">…</vistas-counter></p>
...
<style>
  vistas-counter { font-weight: 600; } /* stylisez-le comme n'importe quel élément */
</style>
```
...
```ts
defineVistasCounter(options?): void   // enregistre <vistas-counter slug endpoint cooldown>
```
