...
// أي صفحة .astro
---
<p>المشاهدات: <viztas-counter slug="blog">…</viztas-counter></p>
...
<style>
  viztas-counter { font-weight: 600; } /*نسّقه كما أي عنصر */
</style>
```
...
```ts
defineViztasCounter(options?): void   // يسجّل <viztas-counter slug endpoint cooldown>
```
