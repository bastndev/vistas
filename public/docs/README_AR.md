...
// أي صفحة .astro
---
<p>المشاهدات: <vistas-counter slug="blog">…</vistas-counter></p>
...
<style>
  vistas-counter { font-weight: 600; } /*نسّقه كما أي عنصر */
</style>
```
...
```ts
defineVistasCounter(options?): void   // يسجّل <vistas-counter slug endpoint cooldown>
```
